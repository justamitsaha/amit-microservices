package com.saha.amit.authenticationservices;
...
public class AuthenticationServicesApplication {
    public static void main(String[] args) {
        System.out.println("http://localhost:8080/authentication/h2-console/");
        System.out.println("http://localhost:8080/authentication/swagger-ui.html");
